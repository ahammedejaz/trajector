...
export function Hero({ rightSlot, onSecondaryClick }: Props) {
  return (
      ...
      <div className={styles.inner}>
        <div className={styles.left}>
          ...
          <p className={styles.sub}>
            Drop your resume on the right. We'll synthesize a candidate profile, score live postings against it, and rank what's actually a fit. Your resume and your API key never leave your browser.
          </p>
